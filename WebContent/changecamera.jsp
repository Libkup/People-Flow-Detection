						...
						<div class="row" style="text-align: center;">
							...
							<div class="col-lg-8">
								<div class="card">
									...
									<div class="card-body">
										<form action="ChangeCamera" method="post"
														...
														<div class="input-group">
															...
															<div class="input-group-append">
																<button type="button" class="btn btn-primary"
																	onclick="SearchCameraInfo()">查询</button>
															</div>
														</div>
													</div>
												</div>
											...
											<div id="text1" style="display: none;" class="form-group row">
												<label class="col-sm-4 form-control-label">标识</label>
												<div class="col-sm-7">
													<input id="cameraname" name="cameraname" type="text" required="required"
														class="form-control">
												</div>
											</div>
											...
											<div id="text2" style="display: none;" class="form-group row">
												...
												<div class="col-sm-7">
													<input id="location" name="location" type="text" required="required"
														class="form-control">
												</div>
											</div>
				...
				$.ajax({
					...
					success : function(result) {
						...
						if (result == "") {
							...
							document.getElementById("lin4").style.display = "none";
			...
			$("#cameraname").blur(function() {
				...
				if (temp != "") {
					if (!reg.test(temp)) {
						alert('请输入正确格式的标识');
						$("#cameraname").val("");
						document.getElementById("cameraname").select();
						$(this).css({
							'outline' : 'none',
							'border-color' : 'rgba(255, 0, 0, 0.8)'
						});
