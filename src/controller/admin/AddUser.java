...
public class AddUser extends HttpServlet {
	...
	private void adduser(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		User user = new User(request.getParameter("UserName"), request.getParameter("UserEmail"), "123456",request.getParameter("gender"), request.getParameter("PhoneNumber"),request.getParameter("position"), request.getParameter("Introduction"), "");
